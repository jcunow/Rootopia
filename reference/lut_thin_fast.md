...
1: - The 3x3 neighborhood is extracted - A weighted sum (mask encoding)
produces a unique neighborhood code 5. The code is used as an index into
a 256-entry lookup table: - LUT value 1 or 3 -\> pixel removed in first
sub-step - LUT value 2 or 3 -\> pixel removed in second sub-step 6.
