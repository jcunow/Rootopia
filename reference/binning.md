...
#> Error in create_depthmap(img, mask, start.soil = 2.9, select.layer = 2): unused argument (select.layer = 2)
binned.map = binning(depthmap,nn = 5)
#> Error in value[[3L]](cond): Error in binning: object 'depthmap' not found
```
