...
output:
    rmarkdown::html_vignette:
        ...
        toc_depth: 2
vignette: >
  %\VignetteIndexEntry{Special Topics: Peat Colour, Soil Texture, Rhizosphere Halos, and Turnover}
...
`classify_peat_rgb()` assigns every pixel of an RGB scan to a
class (e.g., dark peat, red peat, root, silver tape, coarse debris, ...) by
...
texture metrics from a colour image, which can be informative on the spatial heterogeneity within a scan.
...
A simple summary of overall tube colour (mean RGB and a single
